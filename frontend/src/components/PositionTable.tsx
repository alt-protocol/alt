...
export default function PositionTable({ columns, positions, activeType }: PositionTableProps) {
  ...
  if (positions.length === 0) {
    const SIDEBAR_LABELS: Record<string, string> = {
      all: "ALL", lending: "LEND", multiply: "MULTIPLY",
      earn_vault: "VAULTS", insurance_fund: "INSURANCE FUNDS", earn: "EARN",
    };
    const typeLabel = SIDEBAR_LABELS[activeType] ?? activeType.toUpperCase();
    return (
