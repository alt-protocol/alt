---
name: add-page
description: Create a new page in the frontend (app) route group with proper patterns, loading states, and shared components
user_invocable: true
---
...
Create a new page at `frontend/src/app/(app)/<route>/page.tsx` following these patterns:
